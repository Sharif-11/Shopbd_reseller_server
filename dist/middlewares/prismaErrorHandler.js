...
const knownRequestHandler = (error) => {
    ...
    switch (code) {
        ...
        case 'P2005':
            return `Invalid value for field ${(meta === null || meta === void 0 ? void 0 : meta.field_name) || ''}. Value cannot be cast to the field type.`;
        case 'P2006':
            return `Invalid value for field ${(meta === null || meta === void 0 ? void 0 : meta.field_name) || ''}. The provided value is not valid.`;
        case 'P2007':
        ...
        case 'P2010':
            return 'Raw query failed. Error code: ' + ((meta === null || meta === void 0 ? void 0 : meta.code) || 'unknown');
        case 'P2011':
            return 'Null constraint violation. A required field was set to null.';
        case 'P2012':
            return 'Missing a required value in the input.';
        case 'P2013':
            return `Missing required argument ${(meta === null || meta === void 0 ? void 0 : meta.argument_name) || ''} for field ${(meta === null || meta === void 0 ? void 0 : meta.field_name) || ''}.`;
        case 'P2014':
            const modelA = (meta === null || meta === void 0 ? void 0 : meta.model_a_name) || 'Model A';
            const modelB = (meta === null || meta === void 0 ? void 0 : meta.model_b_name) || 'Model B';
        ...
        case 'P2017':
            return `The records for relation ${(meta === null || meta === void 0 ? void 0 : meta.relation_name) || ''} between models are not connected.`;
        case 'P2018':
        ...
        case 'P2021':
            return `The table ${(meta === null || meta === void 0 ? void 0 : meta.table) || ''} does not exist in the current database.`;
        case 'P2022':
            return `The column ${(meta === null || meta === void 0 ? void 0 : meta.column) || ''} does not exist in the current database.`;
        case 'P2023':
