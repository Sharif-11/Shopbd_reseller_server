...
class PaymentRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get('/admin/:paymentId', auth_middlewares_1.isAuthenticated, payment_validator_1.default.getPaymentByIdForAdmin(), validation_middleware_1.default, payment_controller_1.default.getPaymentByIdForAdmin);
