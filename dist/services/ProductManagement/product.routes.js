...
class ProductRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get('/user/:productId', auth_middlewares_1.authenticate, product_validator_1.default.getProductDetailForSeller(), validation_middleware_1.default, product_controller_1.default.getProductDetail);
        // ==========================================
